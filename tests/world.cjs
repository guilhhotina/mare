...
lua.global.set('life_legacy_save',fs.readFileSync(__dirname+'/fixtures/mare3-first-completion.txt','utf8').trim());
await lua.doString(base+fs.readFileSync(__dirname+'/world.lua','utf8')+'\n'+fs.readFileSync(__dirname+'/life.lua','utf8')+'\n'+fs.readFileSync(__dirname+'/traffic.lua','utf8'));lua.global.close();})().catch(e=>{console.error(e);process.exitCode=1;});
